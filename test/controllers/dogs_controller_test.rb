...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { breed_id: @dog.breed_id, dob: @dog.dob, in_daycare: @dog.in_daycare, name: @dog.name, vet_id: @dog.vet_id } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { breed_id: @dog.breed_id, dob: @dog.dob, in_daycare: @dog.in_daycare, name: @dog.name, vet_id: @dog.vet_id } }
